...
set DEFAULT_JVM_OPTS="--module-path" "APP_HOME_LIBS_PLACEHOLDER" "--module" "com.example.java_project/com.example.java_project.HelloApplication"
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %JAVA_PROJECT_OPTS%  -classpath "%CLASSPATH%" --module-path "%MODULE_PATH%" --module com.example.java_project/com.example.java_project.HelloApplication %*
