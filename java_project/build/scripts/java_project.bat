...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "com.example.java_project/no.hiof.groupproject.gui.Main"
...
"%JAVA_EXE%" %JAVA_OPTS% %JAVA_PROJECT_OPTS% %DEFAULT_JVM_OPTS% %CMD_LINE_ARGS%
